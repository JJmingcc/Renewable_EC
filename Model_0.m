function [revenue,cost,P_G,P_C,P_D,P_S,c,x,q,uti_percent] = Model_0(I,J,T,alpha,lambda_fore,phi,C_max,rho,e,a,P_idle,P_peak,P_R,P_C_max,P_G_max,P_D_max,E_max,E_min,E_0,delta,theta_grid,eta_c,eta_d,Delta_T,gamma_max,E_usage)
cvx_begin
    cvx_solver Gurobi_2
    cvx_precision low

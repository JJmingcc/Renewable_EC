function [cost, P_G,c,x,q,uti_percent] = Model_1(I,J,T,alpha,lambda_fore,phi,C_max,rho,e,P_idle,P_peak,P_R,P_G_max,delta,theta_grid,gamma_max,E_usage)
cvx_begin
    cvx_solver Gurobi_2
    cvx_precision low

function [cost,P_G,P_C,P_D,c,x,q,uti_percent] = Model_2(I,J,T,alpha,lambda_fore,phi,C_max,rho,e,P_idle,P_peak,P_R,P_C_max,P_G_max,P_D_max,E_max,E_min,E_0,delta,theta_grid,eta_c,eta_d,Delta_T,gamma_max,E_usage)
cvx_begin
    cvx_solver Gurobi_2
    cvx_precision low
...
%             obj == C_u + C_c;
            ...
            for t = 1:T
                for j = 1:J
                    P_G(j,t) + P_R(j,t) + P_D(j,t) >= P_U(j,t) + P_C(j,t);
                    P_C(j,t) <= P_C_max(j);
                    P_D(j,t) <= P_D_max(j);
                    P_G(j,t) <= P_G_max(j,t);
                end
